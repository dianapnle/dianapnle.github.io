            ...
            <Row>
              <Col md={8} className="home-about-description">
                ...
                <br />
                  ...
                  <b className="yellow"> Java, Python, SQL, and React</b> to name a few. I also have been working with Google App Scripts to automate processes. Additionally, I have some experience working with different Zoho tools.
                  <br />
                  <br />
